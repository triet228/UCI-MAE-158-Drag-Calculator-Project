...
t_c_wing = 0.1793186648;    % Thickness-to-chord ratio
...
for v = 230:880 % True airspeed (ft/s)
    ...
    S_wet_wing = 498.95 + 496.3;             % Wetted area from model (ft^2)
    ...
    C_Dp_total = 1.1 * (C_Dp_wing + C_Dp_fuselage + C_Dp_horizontal_tail + C_Dp_vertical_tail + C_Dp_nacelles);
